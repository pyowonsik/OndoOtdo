...
class MainFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // SpannableString으로 recommendationText를 감싸기
        ...
        // 텍스트뷰에 적용
        binding.RecommendWearInfoArea.text = spannableString
    ...
    private fun getClothingRecommendation(temp: Int, weather: String): String {
        // 기본 옷 추천 문구
